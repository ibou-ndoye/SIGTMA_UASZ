        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .permitAll()
                                                .requestMatchers("/login", "/register", "/api/utilisateurs/inscription")
                                                .permitAll()
                                                .requestMatchers("/admin/**", "/api/utilisateurs/**",
                                                                "/api/admin/stats/**")
                                                ...
                                                .requestMatchers("/api/theses/files/**", "/api/theses/recherche",
                                                                "/api/theses")
                                                .authenticated()
                                                ...
                                                .requestMatchers("/aide-bibliothecaire/**", "/api/aide/**",
                                                                "/api/theses/depot",
